...
class RoiSelectionDialog(QDialog):
    ...
    def _build_layout(self) -> None:
        ...
        layout.addWidget(hint_label("Front is at the top; left is the participant's left. Grey electrodes are unavailable. Save Custom ROI keeps your definition for future sessions; Use ROI applies it to this plot."))
        footer = QHBoxLayout()
